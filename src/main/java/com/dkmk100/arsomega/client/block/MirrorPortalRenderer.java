...
import com.dkmk100.arsomega.blocks.MirrorPortalBlockEntity;
...
public class MirrorPortalRenderer<T extends MirrorPortalBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public MirrorPortalRenderer(BlockEntityRendererProvider.Context rendererDispatcherIn) {
    }
