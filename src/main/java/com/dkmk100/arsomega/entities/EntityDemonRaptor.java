...
public class EntityDemonRaptor extends MonsterEntity {
    public EntityDemonRaptor(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
        this.xpReward = 12;
    }
    @Override
    ...
    @Override
    protected float getStandingEyeHeight(Pose poseIn, EntitySize sizeIn) {return 0.9F;}
}
