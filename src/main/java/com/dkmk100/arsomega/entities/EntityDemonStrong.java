...
public class EntityDemonStrong extends Monster {
    ...
    public boolean canBeAffected(MobEffectInstance effect) {
        if (effect.getEffect() == MobEffects.POISON || effect.getEffect() == MobEffects.WITHER || effect.getEffect() == ModPotions.SNARE_EFFECT || effect.getEffect() == com.dkmk100.arsomega.potions.ModPotions.DEMONIC_CURSE) {
            return false;
        }
