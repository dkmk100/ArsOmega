...
public class EntityDemonStrong extends MonsterEntity {
    public EntityDemonStrong(EntityType<? extends MonsterEntity> type, World worldIn) {
        super(type, worldIn);
        this.xpReward = 12;
    }
    @Override
    ...
    public boolean canBeAffected(EffectInstance effect) {
        if (effect.getEffect() == Effects.POISON || effect.getEffect() == Effects.WITHER || effect.getEffect() == ModPotions.SNARE_EFFECT || effect.getEffect() == com.dkmk100.arsomega.potions.ModPotions.DEMONIC_CURSE) {
            return false;
        }
