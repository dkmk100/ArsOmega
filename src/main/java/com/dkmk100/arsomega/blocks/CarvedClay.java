...
public class CarvedClay extends HorizontalDirectionalBlock implements MagicAnimatable {
    ...
    public void onPlace(BlockState p_220082_1_, Level world, BlockPos p_220082_3_, BlockState p_220082_4_, boolean p_220082_5_) {
        ...
        if (autoConvert && world instanceof ServerLevel) {
            CheckGolem(p_220082_3_, (ServerLevel) world,null);
        }
    }
        ...
        if (pos.getY() > 2) {
            ...
            if (block == clayType) {
                ...
                if (block == clayType) {
                    ...
                    if(golem instanceof EntityClayGolem){
                        EntityClayGolem clayGolem = (EntityClayGolem)golem;
                        if(player!=null) {
                            clayGolem.SetOwner(player);
                        }
                    }
    ...
    @Override
    public void Animate(BlockPos pos, ServerLevel world, @Nullable Player player) {
        CheckGolem(pos,world,player);
    }
}
